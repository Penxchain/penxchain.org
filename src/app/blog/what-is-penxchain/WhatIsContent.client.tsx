...
export default function WhatIsPenxchainPage() {
  const postId = "what-is-penxchain";
        ...
        <article>
          ...
          >
            ...
            <p>
              ...
              ecosystem designed to work smoothly together. Learn{" "}
              <Link href="/blog/why-penxchain-exist">why penxchain exists</Link>,
              or about <Link href="/penxchain-wallet-features">the features of the PENXCHAIN Wallet</Link>,
