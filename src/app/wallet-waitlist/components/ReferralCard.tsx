  ...
  return (
    <div className="relative bg-[#050505] border border-white/5 rounded-xl p-6 hover:border-white/10 transition-colors group">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-white font-bold tracking-tight text-sm uppercase">Invite Protocols</h3>
          <p className="text-white/40 text-[10px] font-mono uppercase tracking-wider">+200 PXP REWARD</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <div className="p-4 bg-white/[0.02] rounded-lg border border-white/5">
          <p className="text-white/30 text-[9px] uppercase tracking-wider mb-1 font-mono">Referrals</p>
          <p className="text-white text-lg font-bold">{user.referralCount}</p>
        </div>
        <div className="p-4 bg-white/[0.02] rounded-lg border border-white/5">
          <p className="text-white/30 text-[9px] uppercase tracking-wider mb-1 font-mono">Earned</p>
          <p className="text-[#2547D0] text-lg font-bold">{user.referralCount * 200}</p>
        </div>
      </div>

      {/* Referral Code */}
      <div className="mb-4">
        <label className="block text-white/30 text-[9px] uppercase tracking-wider mb-2 font-mono">Your Referral Code</label>
        <div className="flex items-center gap-2">
          ...
          >
            {copied ? <Check className="w-4 h-4 text-[#2547D0]" /> : <Copy className="w-4 h-4 text-white/50" />}
          </button>
        </div>
      </div>
      ...
      {/* Referral Link */}
      <div className="mb-4">
        <label className="block text-white/30 text-[9px] uppercase tracking-wider mb-2 font-mono">Uplink Address</label>
        <div className="flex items-center gap-2">
          <input
            type="text"
            value={referralLink}
      ...
      <div className="p-3 bg-white/[0.02] border border-white/5 rounded-lg mt-6">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 text-xs">
            <p className="text-white font-bold mb-1 uppercase tracking-wider text-[10px]">Multiplier Active</p>
            <div className="grid grid-cols-2 gap-2">
               <span className="text-white/40 text-[9px] font-mono">5 REFS → +500 PXP</span>
               <span className="text-white/40 text-[9px] font-mono">10 REFS → +1000 PXP</span>
            </div>
          </div>
        </div>
      </div>
